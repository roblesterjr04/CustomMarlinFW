...
//
  ...
  #define HOTEND0_RESISTANCE_25C_OHMS  10000000  // Resistance at 25C
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_IDLE_TIME    600 // (seconds) Extra time to keep the fan running after disabling motors
 ...
 */
  ...
  #define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY    { X_MIN_POS + 10, Y_MAX_POS - 10 }
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Start Queued Print"
  #define USER_GCODE_5 "M118 A1 action:start"
#endif
